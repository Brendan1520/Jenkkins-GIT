pipeline {
    ...
    stages {
        ...
        stage("Unit and Intergration Test") {
            steps {
                 echo "This stage will help verify that code function as intended and that various components of the programme work together as planned, a Unit Test tool would be NUnit and an Intergration Test tool would be Citrus or Protractor"
            }
